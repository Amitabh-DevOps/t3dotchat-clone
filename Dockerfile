...
# Accept build arguments for all NEXT_PUBLIC_ variables
...
# Fix for NextAuth.js in Docker containers
...
ENV PORT 3000
# Set hostname to accept connections from any IP (required for Docker)
